...
INTENTS = {
    ...
    "explain_concept": [
        r"what is (bos|choch|fvg|order block|liquidity sweep|impulse|hurst)",
        r"explain (bos|choch|fvg|structure|sweep|imbalance|impulse)",
    ...
    "learn_forex": [
        ...
        r"what is (a )?(win rate|expectancy|sharpe|regime|ensemble|order block)",
        r"explain (pip|spread|leverage|lot|margin|stop loss|take profit|candlestick)",
        r"explain (win rate|expectancy|sharpe|drawdown|regime|ensemble|order block)",
        ...
        r"(pip|spread|leverage|margin|lot size|drawdown|sharpe|expectancy|rsi|candle) meaning",
    ],
    "risk_inquiry": [
